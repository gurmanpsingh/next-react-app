			...
			<div id="sidebar-wrapper">
				<div className="main-menu-row">
					<div className="main-menu-inner">
						...
						{/*<li><a href="/">Home</a></li>
							{productResultID ? 
								(<li><a href={baseURL + "/product/" + productResultID}>STARTER KIT</a></li>)
								:
								(<li><a href={baseURL + "/product/1"}>STARTER KIT</a></li>)
							}*/}
					...
					<div className="collapse navbar-collapse" id="navbar">
						<div className="main-menu-row">
							<div className="main-menu-inner">
								<ul>									
									{/*{productResultID ? 
										(<li><a id="firstmanu" href={baseURL + "/product/" + productResultID}>STARTER KIT</a></li>)
										:
										(<li><a id="firstmanu" href={baseURL + "/product/1"}>STARTER KIT</a></li>)
									}*/}
